            ...
            <div ref={ProfileRef} className="bg-PCBG md:col-span-3 rounded-xl sm:ml-0  flex sm:col-span-5 md:mr-0 sm:mr-3 col-span-12 sm:row-span-5 md:row-span-19 mx-3 row-span-4">
                ...
                <div className="flex justify-between w-full">
                    <div className=" w-full">
                        <div className="text-4xl font-medium mt-4 ml-5 mb-2">Skills</div>
                        <div className="ml-12">
                        ...
                        <div className="bg-PCBG2 text-xl font-medium inline-flex  p-3  rounded-xl mt-3 ml-4 ">
                    ...
                    <div className="w-[50%]">
                        <img src={Skill} alt="Skill GIF" className="w-28 mr-[20%]" />
                    </div>
                </div>
            </div>
        </>
